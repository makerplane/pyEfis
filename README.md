...
| src/pyefis/instruments/NumericalDisplay/\_\_init\_\_.py |      201 |        1 |       42 |        0 |     99% |       290 |
...
| src/pyefis/instruments/airspeed/\_\_init\_\_.py         |      346 |        1 |       72 |        9 |     98% |79->81, 216->exit, 278->280, 294, 425->exit, 508->520, 511->520, 517->520, 533->exit |
| src/pyefis/instruments/altimeter/\_\_init\_\_.py        |      262 |        1 |       52 |        2 |     99% |111, 382->exit |
| src/pyefis/instruments/button/\_\_init\_\_.py           |      257 |       47 |      134 |       23 |     74% |83->90, 119->exit, 121->exit, 123->exit, 124->exit, 125->exit, 126->exit, 127->exit, 135, 143-153, 169, 177->exit, 190->exit, 200, 207->exit, 211-212, 219-234, 237->exit, 259->258, 275-283, 310, 319-323, 326-330, 335-337 |
